...
.ob-instrument-dynamic-color-stroke { stroke: var(--instrument-dynamic-color);}

.ob-instrument-dynamic-color-fill { fill: var(--instrument-dynamic-color);}

.ob-instrument-static-color-stroke { stroke: var(--instrument-static-color);}

.ob-instrument-static-color-fill { fill: var(--instrument-static-color);}

.ob-instrument-input-color-stroke { stroke: var(--instrument-input-color);}

.ob-instrument-input-color-fill { fill: var(--instrument-input-color);}
...
.ob-instrument-frame-color-stroke { stroke: var(--instrument-frame-color);}

.ob-instrument-frame-color-fill { fill: var(--instrument-frame-color);}

.ob-instrument-track-color-stroke { stroke: var(--instrument-track-color);}

.ob-instrument-track-color-fill { fill: var(--instrument-track-color);}
